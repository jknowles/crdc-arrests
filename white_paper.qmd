...
<!-- TODO(artifact-repro): Tables 3-6 below are the model coverage/precision
     results, still the ported-static values. Wiring them to artifacts means
     factoring results.qmd's coverage/precision computation (covered / shrinkage /
     improved-precision over the draws view) into a shared builder, applied to the
     four sample definitions (full / with-arrest / 100-most-arrests /
     100-no-arrests). Deferred per Task 18 scope. -->
