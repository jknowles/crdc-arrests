...
<!-- PORTED from inst/AERA Final Report Knowles Miller_preprint.docx (Word source).
     Task 18 replaces the static figures/tables below with artifact-backed chunks. -->
...
<figure>
<img src="inst/paper_media/media/image1.png" style="width:4.64861in;height:3.50556in" alt="A graph of different colored columns AI-generated content may be incorrect." />
<figcaption><p>Figure 1: 2021-22 National arrest rates by select student groups</p></figcaption>
</figure>
...
Unfortunately, this classical approach has limitations in cases of extremely rare events. To show this, let's look at how this approach works in four cases of state student-group arrest rates from the 2021-22 CRDC. Table 1 shows the arrest rate and the Agresti-Coull approximate 95% confidence interval for the rate for four student groups. The rate and interval are adjusted to be per 1,000 students.
  ...
  **Observation**                           **Arrests**   **Enrollment**   **Rate per 1,000**   **95% interval (per 1,000)**
  ----------------------------------------- ------------- ---------------- -------------------- ------------------------------
  AK Black Female                           0             922              0                    0 -- 3.13

  AK Black Male                             2             960              2.08                 0 -- 6.14

  AK American Indian / Alaska Native Male   4             11,052           0.36                 0 -- 0.79

  CO American Indian / Alaska NativeMale    2             1,816            1.10                 0 -- 3.25
  ----------------------------------------------------------------------------------------------------------------------------
...
<figure>
<img src="inst/paper_media/media/image2.png" style="width:5.57014in;height:5.57014in" alt="A screenshot of a graph AI-generated content may be incorrect." />
<figcaption><p>Figure 2: Model predictions for Paterson NJ arrests compared to frequentist interval with 0 reported arrests</p></figcaption>
</figure>
...
<figure>
<img src="inst/paper_media/media/image3.png" style="width:5.59722in;height:5.59722in" alt="A graph of different models AI-generated content may be incorrect." />
<figcaption><p>Figure 3: Distribution of predicted arrests for Paterson NJ across all models</p></figcaption>
</figure>
...
<figure>
<img src="inst/paper_media/media/image4.png" style="width:5.32708in;height:5.32708in" alt="A screenshot of a graph AI-generated content may be incorrect." />
<figcaption><p>Figure 4: Model predictions for Mobile County, AL arrests compared to frequentist interval</p></figcaption>
</figure>
...
<figure>
<img src="inst/paper_media/media/image5.png" style="width:4.93889in;height:4.93889in" alt="A screenshot of a graph AI-generated content may be incorrect." />
<figcaption><p>Figure 5: Distribution of predicted arrests for Mobile County, AL across all models compared to frequentist interval</p></figcaption>
</figure>
...
<figure>
<img src="inst/paper_media/media/image6.png" style="width:5.09931in;height:5.09931in" alt="A screenshot of a graph AI-generated content may be incorrect." />
<figcaption><p>Figure 6: Distribution of model arrest rate estimates for male students by race in Clark County, NV</p></figcaption>
</figure>
...
<figure>
<img src="inst/paper_media/media/image7.png" style="width:5.76389in;height:4.80347in" alt="A screenshot of a graph AI-generated content may be incorrect." />
<figcaption><p>Figure 7: Estimates of the Hispanic - White arrest rate disparity for male students in Clark County, NV</p></figcaption>
</figure>
...
<figure>
<img src="inst/paper_media/media/image8.png" style="width:5.84375in;height:4.86944in" alt="A screenshot of a graph AI-generated content may be incorrect." />
<figcaption><p>Figure 8: Reevaluating estimates of state level arrest rate differences by student group from Table 1</p></figcaption>
</figure>
...
To help guide future research applying models to sparse and rare events, we report the computation time, dataset size, and number of estimated parameters for our unified and stratified models below. We show how the time to fit models scales with the complexity of the model and the size of the dataset. For unified models we report the runtime to complete all four sampler chains; for the stratified models we report the sum of the runtime for the model fit to each of the eight subsets. We also report the number of parameters each model estimated. For unified models this includes the random intercepts and fixed effects. For the stratified models, it includes the sum of those parameters for each of the eight model subsets. Finally, some models required a longer sampling run -- in terms of the number of iterations --to converge and provide stable results. In general, more complex models require a greater number of iterations to achieve convergence among the sampler chains and produce reliable estimates. We report the number of iterations per chain as it has a significant impact on runtime. Where necessary, more iterations were used to ensure that the sampling chains converged and that enough effective samples were obtained for analysis of the posterior.
  ...
  -------------- -------------------- ----------- ------------ ----------------------
  Unified 1      51.3                 106,703     16,279       3,500

  Unified 2      50.4                 106,703     16,340       3,500

  Unified 3      285                  307,468     17,101       3,500

  Unified 4      287                  307,468     17,102       4,000

  Unified 5      288                  307,468     17,103       4,000

  Stratified 1   22                   106,703     107,127      2,000 (x 8 models)

  Stratified 2   31.2                 106,703     107,135      3,500 (x 8 models)

  Stratified 3   98.8                 307,468     120,971      3,500 (x 8 models)

  Stratified 4   167                  307,468     121,512      4,300 (x 8 models)

  Stratified 5   149.2                307,468     121,528      4,000 (x 8 models)
  -----------------------------------------------------------------------------------

  : Table A1: Model computation times
